...
#include "constants.h"
  ...
  r_halo = 0.001d0
  zsave = (/ 10.d0, 2.d0,  1.d0, 0.5d0, 0.4d0, 0.3d0, 0.2d0, 0.1d0, 0.d0/)
  ...
  call halo%init(Omega_m = Omega_m, nr = 1024, rmax = r_halo*30.d0, a_ini = 1.d0/(1.d0+z_ini), delta_ini = delta_ini, r_halo = r_halo, bw_halo = r_halo/30.d0, dtau = r_halo/200.d0)
  halo%QS_approx = .true.
  halo%do_GR = .false.
  ...
  do i=1, nsave
     ...
     enddo
     call halo%feedback("collapse_QS"//COOP_STR_OF(i)//".txt")
