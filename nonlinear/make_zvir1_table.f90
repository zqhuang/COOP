...
#include "constants.h"
  ...
  type(coop_ellipse_collapse_params)::params(nthreads)
  ...
  call coop_get_command_line_argument(key = "numf", arg = nf, default = 100)
  call coop_get_command_line_argument(key = "nume", arg = ne, default = 50)
  call coop_get_command_line_argument(key = "nump", arg = np, default = 100)
  ...
  call coop_get_command_line_argument(key = "fmax", arg = fmax, default = 20.d0)
  ...
  write(*,*) "========================================================"
  write(*,*) "./TabZ1 -out ... [-binary ...(T)] [-numf ...(100)] [-nume ...(50)] [-nump ...(100)] [-logf ...(T)] [-fmax ...(20)] [-fmin ...(1.5)] [-emax ...(1)] [-emin ...(0)] [-pmax ...(emax)] [-pmin ...(-emax)] ... [-omm ...(0.3)] [-omk ...(0.)] [-h ...(0.7)] [-w ...(-1)] [-fr1 ...(0.18)] [-fr2 ... (0.18)] [-fr3 ... (0.18)]"
  write(*,*) "Examples:"
  ...
  call coop_set_uniform(ne, p, pmin, pmax)
