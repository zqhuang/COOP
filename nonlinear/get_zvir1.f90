...
#include "constants.h"
  ...
  COOP_REAL::Omega_m,w, Omega_k, h, wa, epsilon_s, zvir1
  COOP_REAL::F_pk, p_nu, e_nu
  if(iargc().lt.2)then
     write(*,*) "========================================================"
     write(*,*) "./GetZ1 [-omm ...(0.3)] [-omk ...(0.)] [-h ...(0.7)] [-w ...(-1)] [ -wa...(0)] [-eps...(0)] [-fr1 ...(0.178)] [-fr2 ... (0.178)] [-fr3 ... (0.178)] "
     write(*,*) "Examples:"
  ...
  call params%init(Omega_m = Omega_m, Omega_k = Omega_k, h = h, w = w, wa = wa, epsilon_s = epsilon_s)
  do
     read(*,*) F_pk, e_nu, p_nu
