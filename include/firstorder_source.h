    ...
    case(0) !!scalar
       if(pert%a .le.  coop_visibility_amin)then
          ...
          if(pert%tight_coupling)then
             ...
             Pddot =  (pert%k * pert%aH*((2.d0/3.d0)*pert%O1_T_PRIME(1) - (3.d0/7.d0)*pert%O1_T_PRIME(3) + coop_sqrt6*coop_sqrt5/7.d0 * pert%O1_E_PRIME(3))  - ( 3.d0*Pdot)/(pert%aH*pert%tauc) + (3.d0*pert%capP)/(pert%aH*pert%tauc)**2*(pert%daHdtau*pert%tauc + pert%aH*pert%taucdot))/10.d0
          endif
          ...
          source%s(2, ik, itau) =vis * pert%capP * (3.d0/8.d0)/max( (this%tau0 - pert%tau)*pert%k, 1.d-4)**2
