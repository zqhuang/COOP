...
#define ZETA_TRANS_HIGH_ACCURACY COOP_NO
#define COOP_SHORT_INT integer(coop_short_int_length)
...
#define COOP_UPPER_STR(x) trim(coop_str_numUpperAlpha(x))
...
#define COOP_INTERPOLATE_ZIGZAG 6
