...
!!in the limit lnam -> - infinity, apparently you get lnrho = 0 and lnp = ln(1/3)
  ...
  subroutine coop_boson_get_dlnp(lnam, dlnp)
    COOP_REAL lnam, dlnp, corr, invam2
    COOP_REAL, dimension(20),parameter::cdrho =   (/ -0.38445753351392464d+00, -0.56507922513479980d+00, -0.16911534555220517d+00, 0.70714005528823232d-1 , 0.77731140160035683d-1 , 0.62217410104989388d-2 , -0.22858414171934623d-1 , -0.10462112478909665d-1 , 0.31397644217964569d-2 , 0.42830853648848930d-2 , 0.72075785662759496d-3 , -0.90785063326038519d-3 , -0.55131656392327173d-3 , 0.11882642415894909d-4 , 0.14421947573201171d-3 , 0.60608967122437350d-4 , -0.86129681024491393d-5 , -0.19507626000606408d-4 , -0.90584422331560452d-5 , 0.43136694416906456d-6  /)
    if(lnam .le. -3.99_dl)then
       corr = (5_dl/4_dl/coop_pi**2)*exp(2_dl*lnam)
       dlnp = -2.* corr/(1.-corr)
       return
