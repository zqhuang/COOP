...
!!time
COOP_REAL, parameter::coop_SI_PlanckTime = 5.39124d-44
...
!!length
COOP_REAL, parameter::coop_SI_PlanckLength = 1.616252d-35
...
COOP_REAL, parameter::coop_SI_PlanckEnergy = 1.2209d19 * coop_SI_GeV
COOP_REAL, parameter::coop_SI_H_bind = 13.605698 * coop_SI_eV
!!mass
COOP_REAL, parameter::coop_SI_PlanckMass = coop_SI_PlanckEnergy/coop_SI_c**2
COOP_REAL, parameter::coop_SI_Reduced_PlanckMass = coop_SI_PlanckMass/sqrt(8.d0*coop_pi)
...
!!temperature
COOP_REAL, parameter::coop_SI_PlanckTemperature = coop_SI_PlanckEnergy / coop_SI_kB
