...
for i in range(5, 15):
    ...
    copy_replace_first_append(baseini, iniroot + r'scan_pp'+str(i)+'.ini', [covmat_pattern, common_pattern, r'^file_root\s*=.+$' , r'^action\s*=.+$', r'^compute\_tensors\s*=.+$', r'^(cmb\_dataset\[BICEP2\].*)$', propose_pattern], [covmat_repl + r'scan_pp' + str(i)+r'.covmat', r'DEFAULT(' + batch_dir + '/common_pp.ini) \nde_model = 0 \nde_num_params = 2\npp_model = 1 \npp_num_params = ' + str(ppnum+i) + r'\nparamnames = paramnames/params_scanp' + str(i) + r'.paramnames', r'file_root = scan_pp'+str(i) , r'action = 0', r'compute_tensors = T', r'\#\1',str_propose], r'param[ns] = 1.')    
    copy_replace_first(baseini, iniroot + r'dpp'+str(i)+'.ini', [covmat_pattern, common_pattern, r'^file_root\s*=.+$' , r'^action\s*=.+$', r'^compute\_tensors\s*=.+$', r'^(cmb\_dataset\[BICEP2\].*)$', propose_pattern], [covmat_repl + r'dpp' + str(i)+r'.covmat', r'DEFAULT(' + batch_dir + '/common_pp.ini) \nde_model = 0 \nde_num_params = 2\npp_model = 1 \npp_num_params = ' + str(ppnum+i) + r'\nparamnames = paramnames/params_scanp' + str(i) + r'.paramnames', r'file_root = dpp'+str(i) , r'action = 0', r'compute_tensors = T', r'\#\1',str_propose])
    for fidr in listr:
        copy_replace_first_append(baseini, iniroot + r'dpp'+str(i)+'_fixrp' + fidr + r'.ini', [covmat_pattern, common_pattern, r'^file_root\s*=.+$' , r'^action\s*=.+$', r'^compute\_tensors\s*=.+$', r'^(cmb\_dataset\[BICEP2\].*)$', propose_pattern], [covmat_repl + r'dpp' + str(i)+r'_fixrp' + fidr + r'.covmat', r'DEFAULT(' + batch_dir + '/common_pp.ini) \nde_model = 0 \nde_num_params = 2\npp_model = 1 \npp_num_params = ' + str(ppnum+i) + r'\nparamnames = paramnames/params_scanp' + str(i) + r'.paramnames', r'file_root = dpp'+str(i)+r'_fixrp' + fidr , r'action = 0', r'compute_tensors = T', r'\#\1',str_propose], r'param[r] = 0.' + fidr)
        if(fidr == "100"):
            copy_replace_first_append(baseini, iniroot + r'dpl'+str(i)+'_fixrp' + fidr + r'.ini', [covmat_pattern, common_pattern, r'^file_root\s*=.+$' , r'^action\s*=.+$', r'^compute\_tensors\s*=.+$', r'^(cmb\_dataset\[BICEP2\].*)$', propose_pattern], [covmat_repl + r'dpl' + str(i)+r'_fixrp' + fidr + r'.covmat', r'DEFAULT(' + batch_dir + '/common_pp.ini) \nde_model = 0 \nde_num_params = 2\npp_model = 2 \npp_num_params = ' + str(ppnum+i) + r'\nparamnames = paramnames/params_scanp' + str(i) + r'.paramnames', r'file_root = dpl'+str(i)+r'_fixrp' + fidr , r'action = 0', r'compute_tensors = T', r'\#\1',str_propose], r'param[r] = 0.' + fidr)
