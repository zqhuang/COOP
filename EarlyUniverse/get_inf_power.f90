...
#include "constants.h"
  ...
  type(coop_file)::fp
  call coop_infbg%setup(nflds = 2, epsilon_end = 1.d0, f_ini = (/ 5.d0*coop_lattice_Mp, 3.d-6*coop_lattice_Mp /) )
  write(*,"(A)") "================================================================================="
  ...
  !!------------------------------------------
  call p%init(lnkmin = lnkMpc+log(0.05d0), lnkmax = lnkMpc+log(100.d0), is_diagonal = .false.)
  ...
  write(fp%unit,'(A10, 2A14, 3A10, 3A14)') " # k Mpc ", " P_S(num) ",  " P_S ", " 1-n_s ", " r ", " n_t ",  " H ", " phi ", " chi " 
  do ik=1, p%nk
