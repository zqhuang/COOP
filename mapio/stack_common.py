...
#stack(imap, spots_tmax_orient, "T", zmin = -20., zmax = 80)
#stack(imap, spots_tmin_orient, "T")
#stack(emap, spots_tmax_orient, "E")
#stack(zetamap, spots_tmax_orient, "zeta")
stack(polmap, spots_tmax_orient, "QU", zmin = -0.37, zmax=0.45)
...
#stack(polmap, spots_ptmax, "QU", zmin = -0.35, zmax = 0.4)
#stack(polmap, spots_pmax, "QU", zmin = -0.95, zmax = 1.5)
