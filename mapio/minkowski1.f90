...
#include "constants.h"
  ...
  COOP_REAL::global_mean, global_rms, summ, global_sigma1, gauss_V1, Amp
  ...
  if(nside .gt. 0)then
     ...
     call map%scan_local_minkowski1(1, 2, 3, nu, meanmap, rmsmap, sigma1map, V1map, r_deg, do_gaussian_fit = gf)  
