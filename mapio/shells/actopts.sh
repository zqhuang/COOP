...
output=${outdir}/${outprefix}_${fwhm}a_l${lmin}
...
./Stack -map ${mapdir}/${prefix}_qu_${fwhm}a_l${lmin}-${lmax}.fits -peaks spots/${outprefix}_l${lmin}_${fwhm}a_hot_nu1.dat -field QrUr -out ${output}_randrot_QrUronHotnu1 -width 4.5 -height 4 -min ${5} -max ${6}   -min2 ${5} -max2 ${6}  -mask ${mapdir}/${prefix}_polmask_${fwhm}a_l${lmin}-${lmax}.fits -radius ${radius} -randrot T -res 50
...
./Stack -map ${mapdir}/${prefix}_qu_${fwhm}a_l${lmin}-${lmax}.fits -peaks spots/${outprefix}_l${lmin}_${fwhm}a_hot_nu1.dat -field QrUr -out ${output}_norot_QrUronHotnu1 -width 4.5 -height 4  -min ${5} -max ${6}  -min2 ${5} -max2 ${6}  -mask ${mapdir}/${prefix}_polmask_${fwhm}a_l${lmin}-${lmax}.fits -radius ${radius} -randrot F -res 50
...
./GetTheo -cl planck14best_lensedCls.dat -auto 1 -cross 1 -field T -peak RANDOM -out ${outdir}/theory_noiseless_l${lmin}_${fwhm}a_TonHotnu1 -nu 1 -orient RANDOM -fwhm ${fwhm} -hot T -lmax ${lmax} -hpauto_lowl $((${lmin}-10)) -hpauto_highl $((${lmin}+10)) -hpcross_lowl $((${lmin}-10)) -hpcross_highl $((${lmin}+10)) -radius ${radius}

./GetTheo -cl planck14best_lensedCls.dat -auto 1 -cross 4 -field E -peak RANDOM -out ${outdir}/theory_noiseless_l${lmin}_${fwhm}a_EonHotnu1 -nu 1 -orient RANDOM -fwhm ${fwhm} -hot T -lmax ${lmax} -hpauto_lowl $((${lmin}-10)) -hpauto_highl $((${lmin}+10)) -hpcross_lowl $((${lmin}-10)) -hpcross_highl $((${lmin}+10)) -radius ${radius}
