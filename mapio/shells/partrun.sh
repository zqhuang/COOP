...
#./FStack -map ${mapdir}/${prefix}_${fwhm}a_l${lmin}-${lmax}_QU.fsm -peaks spots/${outprefix}_l${lmin}_${fwhm}a_Thotcold_nupt5.dat -field QrUr -out ${output}_randrot_QrUronThotcoldnupt5 -width 4.5 -height 4 -min ${7} -max ${8} -min2 ${7} -max2 ${8} -radius ${radius} -randrot T -res ${res}  -norm_to_corr ${norm} -norm_power ${npw}
